README:	
This is an example of personalized http server which have implemented following endpoints:
...
You can also used the Makefile to run the program - just type make in the lion command and then bin/assignment2
